...
| 4 | Fan-out LQFP144, развязка | 4 ч | ✅ 20 VDD/VSS стаб+виа к плитам In1/In2 (виа спрятаны под корпусом), дропы всех развязок |
| 5 | Разводка QSPI (приоритет №1) + выравнивание длин | 6 ч | ✅ связность 6/6 + меандры выравнивания: D0–D3 = 48.54 мм, **скью 0.01 мм** (цель ±0.5), CLK 54.1, CS 29.5; гео-DRC 0 |
| 6 | USB диффпара, SPI, I2C, UART | 6 ч | 🟡 SPI→U4 (CLK/MOSI/CS) + J4 (MISO/CS), I2C-дерево (5 отводов/цепь, 2 плановых F-хопа), UART→J2 — гео-DRC 0; остаток для интерактивного KiCad: USB 90Ω диффпара (нужен связанный pair-роутер), SPI CLK/MOSI→J4 pins 5/7 (конфликт порядка lane/riser) |
| 7 | Полигоны питания L3, силовые цепи, stitching | 4 ч | ✅ 12V→D1→buck→L1→5V (виа в 5V-полигон In2), LDO-дропы в 3V3-полигон, локальная шина 1V8+TP4, EN через B-хоп; DRC 0. Найден и исправлен оверлап падов D1/J1 (сдвиг силового ряда) |
